...
class CrowdAIDataset(Dataset):
    def __init__(self, data_root='C:\ZTB\Dataset\CrowdAI_split', mode='train', img_dir='image', mask_dir='label',
                 img_suffix='.jpg', mask_suffix='.jpg', transform=None, mosaic_ratio=0.25,
