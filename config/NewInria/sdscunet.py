...
from geoseg.datasets.new_inria_dataset import *
...
classes = CLASSES
precision=32
weights_name = "sdscunet-epoch45-bz8-0204"
weights_path = "D:/ZTB/Results/AdditonalExp/NewInria/{}".format(weights_name)
test_weights_name = weights_name
log_name = "D:/ZTB/Results/AdditonalExp/NewInria/log/{}".format(weights_name)
monitor = 'val_mIoU'
monitor_mode = 'max'
save_top_k = 5
save_last = True
