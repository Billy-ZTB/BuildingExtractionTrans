...
from geoseg.datasets.CTC_dataset import *
...
weights_path = "D:\ZTB\Results\AdditonalExp\CTC/{}".format(weights_name)
test_weights_name = weights_name
log_name = "D:\ZTB\Results\AdditonalExp\CTC/log/{}".format(weights_name)
monitor = 'val_mIoU'
monitor_mode = 'max'
save_top_k = 5
save_last = True
